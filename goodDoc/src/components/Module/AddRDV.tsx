...
import { useCreateAssistantMutation } from '../../graphql/generated/graphql'

const AddRDV: React.FC = () => {
  ...
  return (
    <>
      <button
        type="button"
        className="inline-flex -ml-px relative items-center px-4 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-900 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600"
        onClick={() => {
          setOpen(true)
        }}
      >
